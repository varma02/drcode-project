...
export default function Message ({name, message} : {name:string, message:string}) {
  ...
  return (
    <div className='p-2 rounded-xl flex items-center gap-2 cursor-pointer hover:scale-[1.025] transition-all overflow-hidden select-none shadow-lg shadow-black/25' onClick={() => setIsOpen(!isOpen)}>
