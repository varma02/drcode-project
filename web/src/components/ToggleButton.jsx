...
export const ToggleButton = ({onText, offText, onch, value}) => {
  ...
  return (
    <div className={`relative flex items-center ${value ? "bg-gradient-to-br from-green-500 to-green-800" : "bg-gradient-to-br from-red-500 to-red-800"} rounded-full px-2 py-0.5 select-none transition-all`} >
